...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        estudante1.adicionarNota(8.5, 6.0, 9.0, 3.0, 3.0, 4.0);  // Corrigido: Passando Double explícito

        Estudante estudante2 = new Estudante("Mirele Oliveira", "333.333.33-3", "Rua C, Bairro D", "998877665",
                "2023002");
        estudante2.adicionarNota(7.0, 8.0, 8.5, 4.0, 3.0, 3.0);  // Corrigido: Passando Double explícito

        Estudante estudante3 = new Estudante("Ana Costa", "444.444.444-4", "Rua E, Bairro F", "985633211", "5552668");
        estudante3.adicionarNota(5.0, 4.5, 6.0, 2.0, 3.0, 5.0);  // Corrigido: Passando Double explícito

        Estudante estudante4 = new Estudante("Andressa Mota", "555.555.555-5", "Rua G, Bairro H", "998544721",
                "5586441");
        estudante4.adicionarNota(10.0, 9.0, 8.5, 5.0, 3.0, 2.0);  // Corrigido: Passando Double explícito
